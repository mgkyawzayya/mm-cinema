...
@section('content')
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <a href="{{ url('mandalay/cinema/create') }}" class="btn btn-success btn-round text-right">New</a>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach( $cinemas as $cinema)
                                            <tr>
                                                ...
                                                <td class="td-actions">
                                                    <a href="{{ url('/mandalay/cinema/edit/' . $cinema->id) }}" class="btn btn-success btn-round">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <form action="{{ url('mandalay/cinema/destroy/' . $cinema->id) }}" method="post">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete') }}
